...
public class Pig {
    ...
    Crazy idea: When we format our input, we replace every "y" that's the first letter of a word with ¥ (option-Y).
  ...
  **/
  ...
  public static void main( String[] args ) {
    ...
    System.out.println( engToPig("myanmar") ); // System.out.println( engToPig("i") ); // i
